...
import "./App.css";
import { Link, MapPin, Database, ArrowDownRight } from 'lucide-react';
...
export default function App() {
  return (
    <div>
      ...
      <section>
        <h2> <Database /> O que é o MySQL?</h2>
        <p>
      ...
      <section>
        <h2> <ArrowDownRight /> Características</h2>
        <p>
